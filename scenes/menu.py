...
def play_menu(screen):
    button_range = io.Button(700, 150, 200, 80, RED, BLACK, "Стрельбище", io.range)
    button_offline = io.Button(700, 250, 200, 80, RED, BLACK, "Оффлайн", io.offline)
    button_online = io.Button(700, 350, 200, 80, RED, BLACK, "Оnline", io.online)
    button_settings = io.Button(700, 450, 200, 80, RED, BLACK, "Settings", io.settings)
